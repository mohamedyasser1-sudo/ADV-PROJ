...
class generate_link{
	...
	function __construct($advertise_id,$publisher_id){
        ...
        echo $this->get_current_url().'/paypal/new/ADV-PROJ/process.php?pub='.$this->encryption_advertisment_id($publisher_id).'&sect='.$this->encryption_advertisment_id($advertise_id);        
	}

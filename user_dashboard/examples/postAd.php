...
<div class="content">
  <div class="container-fluid">
    <div class="card">
      ...
      <br>
      <div class="card-body">
        <form action="payments.php" method="post" id="paypal_form" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-row text-center">
                    <div class="col-12">
                      ...
                      <button type="submit" name="submit" value="Submit Payment" id="itcost" class="btn btn-primary btn-lg-cus">
                        It cost 10$
                        <br>
